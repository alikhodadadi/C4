...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This script learnes the parameters of CC model for real data using train
...
if ~(exist('batchTest','var') && batchTest == true)
    ...
    train_percent = 0.8;
    data.beta = 100; % the parameter of exponential
end
...
%%-----saving the results ------%%
if  ~(exist('batchTest','var') && batchTest == true)
    saveFile = fullfile(pwd, '..','Results', 'Real' ,'Inference',  ...
        [ dataset '_CC_results_beta_' num2str(data.beta) '_' num2str(train_percent) '.mat']);
else
    saveFile = fullfile(pwd, 'Results', 'Real', 'Inference', ...
        [dataset '_CC_results_beta' num2str(data.beta) '_' num2str(train_percent) '.mat']);
end
